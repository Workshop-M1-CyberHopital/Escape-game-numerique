        ...
        <div v-if="isCompleted" class="mt-6">
            ...
            >
                ...
                <p class="text-gray-300 mb-4">
                    Excellent ! Vous avez remis les coupes IRM dans le bon
                    ordre. Le système d'imagerie est restauré.
                </p>
                <div
                    class="bg-cyan-900/30 border border-cyan-500/50 rounded p-3 mb-4"
                >
                    <div class="text-cyan-400 font-tech text-sm">
                        <strong>APPRENTISSAGE :</strong> L'IRM permet de
                        visualiser le cerveau en coupes pour détecter tumeurs,
                        AVC et lésions. Protéger ces systèmes est vital.
                    </div>
                </div>
                <button
                    @click="$emit('room-completed', 'imaging')"
