          ...
          <div class="flex items-center gap-4">
            ...
            <div>
              ...
              <p class="text-sm text-gray-300 font-tech">
                Unité de Cybersécurité Médicale - Salle des Prothèses
              </p>
              <div class="flex items-center gap-2 mt-1">
                <div class="w-2 h-2 bg-cyber-green rounded-full animate-pulse"></div>
                <span class="text-xs text-cyber-green font-tech">MISSION CRITIQUE - RÉPARATION PROTHÈSES</span>
              </div>
            </div>
          </div>
          ...
          <div class="flex items-start gap-4">
            ...
            <div class="flex-1">
              ...
              <div class="text-white font-tech leading-relaxed">
                <p class="mb-4">
                  <span class="text-cyber-green">Agent,</span> vous êtes maintenant dans la <span class="text-yellow-400">Salle des Prothèses.</span>
                </p>
                <p class="mb-4">
                  Le <span class="text-cyber-green">système de prothèses a été endommagé</span> par l'attaque cyber. Nos patients ont besoin de <span class="text-yellow-400">prothèses fonctionnelles</span> pour leur rééducation.
                </p>
                <p class="mb-4">
                  <span class="text-cyber-blue">Votre mission :</span> réparer et calibrer les prothèses bioniques pour restaurer leur fonctionnement optimal.
                </p>
                <div class="bg-cyber-green/20 border border-cyber-green/50 rounded p-4 mb-4">
                  <div class="text-cyber-green font-bold text-sm mb-2">⚠️ ALERTE CRITIQUE</div>
                  <div class="text-gray-300 text-sm">
                    Les prothèses sont connectées au réseau hospitalier. Chaque erreur de calibration peut affecter directement la mobilité des patients.
                  </div>
                </div>
                <p class="mb-4">
                  <span class="text-yellow-400">Attention :</span> chaque prothèse doit être parfaitement calibrée. Une mauvaise configuration peut causer des <span class="text-cyber-green">blessures</span> aux patients.
                </p>
                <p class="mb-4">
                  Commencez par analyser les <span class="text-cyber-blue">données de calibration.</span> Vérifiez les paramètres de chaque prothèse.
                </p>
                <p class="mb-4">
                  Une fois les prothèses réparées, vous pourrez accéder aux autres zones critiques du réseau.
                </p>
                <p class="text-center text-cyber-green font-bold mt-6">
                  Bon courage, agent. La mobilité des patients dépend de votre réussite.
                </p>
              </div>
            </div>
          </div>
