<template>
  ...
  >
    <div class="bg-gray-900/95 border-2 border-cyber-blue rounded-lg max-w-4xl w-full relative overflow-hidden">
      <!-- Scanlines effect -->
      ...
      <div class="border-b border-cyber-blue/50 p-6">
        <div class="flex items-center justify-between">
          <div class="flex items-center gap-4">
            <!-- Agent Avatar -->
            <div class="relative">
              <div class="w-16 h-16 bg-gradient-to-br from-cyber-blue to-cyber-purple rounded-full flex items-center justify-center border-2 border-cyber-blue">
            ...
            <!-- Agent Info -->
            <div>
              <h3 class="text-xl font-bold text-cyber-blue font-tech">
                AGENT CYBER-001
              </h3>
              ...
              <div class="flex items-center gap-2 mt-1">
                ...
                <span class="text-xs text-red-400 font-tech">TRANSMISSION EN COURS</span>
              </div>
            </div>
          </div>
      ...
      <!-- Message Content -->
      <div class="p-6">
        <div class="bg-gray-800/50 border border-cyber-blue/30 rounded-lg p-6">
          <div class="flex items-start gap-4">
            ...
            <div class="flex-1">
              ...
              <div class="text-white font-tech leading-relaxed">
                <p class="mb-4">
                  <span class="text-cyber-blue">Unité de Cybersécurité Médicale,</span> vous êtes maintenant opérationnels.
                </p>
                <p class="mb-4">
                  Une <span class="text-red-400">cyberattaque massive</span> a compromis les systèmes vitaux de l'Hôpital Numérique Central. 
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-6">
                  ...
                  <div class="bg-green-900/20 border border-green-500/50 rounded p-3">
                    <div class="text-green-400 font-bold text-sm">SALLE D'IMAGERIE</div>
                    <div class="text-gray-300 text-xs">Scanners médicaux hors service</div>
                  </div>
                ...
                <p class="mt-6 text-cyber-blue">
                  <span class="text-yellow-400">L'heure tourne,</span> et des vies sont en jeu.
                </p>
                <p class="mt-4 text-center text-cyber-blue font-bold">
                  Sélectionnez votre première cible et commencez la mission.
                </p>
